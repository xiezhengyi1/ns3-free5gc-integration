...
def _build_flow_from_row(row: dict[str, object]) -> dict[str, object] | None:
    ...
    flow: dict[str, object] = {
        ...
        "dl_packet_size_bytes": _as_float(row.get("dl_packet_size_bytes")) or _as_float(row.get("packet_size_bytes")),
        "ul_packet_size_bytes": _as_float(row.get("ul_packet_size_bytes")) or _as_float(row.get("packet_size_bytes")),
        "dl_arrival_rate_pps": _as_float(row.get("dl_arrival_rate_pps")) or _as_float(row.get("arrival_rate_pps")),
        "ul_arrival_rate_pps": _as_float(row.get("ul_arrival_rate_pps")) or _as_float(row.get("arrival_rate_pps")),
